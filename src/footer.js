        ...
        const content = `
            <div class="footer__body">
                <div class="footer__column">
                    <h4>About Us</h4>
                    <p class="light-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                ...
                <div class="footer__column">
                    <div class="footer__item">
                        <h4>Opening Hours</h4>
                        <p class="light-text">Monday-Thursday <br> 10AM - 9PM</p>
                        <p class="light-text">Friday-Sunday <br> 10AM - 12AM</p>
                    </div>
                    <div class="footer__item">
                        <h4>Contact Info</h4>
                        <div class="footer__contact light-text">
